...
/**
 * Configuration class for setting up various components and beans required for the application.
 * This class provides configuration for user details, authentication, and password encoding.
 */
@Configuration
